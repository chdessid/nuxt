...
!(function (t, e) {
  ...
  function T(t, e, i) {
    const n = "string" == typeof e,
      o = n ? i : e;
    let s = P(t);
    return S.has(s) || (s = t), [n, o, s];
  }
  function D(t, e, i, n, o) {
    if ("string" != typeof e || !t) return;
    if ((i || ((i = n), (n = null)), e in x)) {
      const t = (t) =>
        function (e) {
          if (
            !e.relatedTarget ||
  ...
  const z = {
      ...
      off(t, e, i, n) {
        ...
        if (void 0 !== s) {
          if (!l || !l[r]) return;
          return void O(t, l, r, s, o ? i : null);
        }
      ...
      trigger(t, e, i) {
        ...
        const l = new Event(e, { bubbles: s, cancelable: !0 });
        if (void 0 !== i)
  ...
  const F = {
    ...
    getDataAttribute: (t, e) => j(t.getAttribute(`data-bs-${q(e)}`)),
  };
  class B {
    static get Default() {
      return {};
    ...
    _mergeConfigObj(t, e) {
      const i = s(e) ? F.getDataAttribute(e, "config") : {};
      return {
        ...this.constructor.Default,
        ...("object" == typeof i ? i : {}),
        ...(s(e) ? F.getDataAttributes(e) : {}),
        ...("object" == typeof t ? t : {}),
      };
    }
  ...
  const W = (t, e = "hide") => {
    const i = `click.dismiss${t.EVENT_KEY}`,
      o = t.NAME;
    z.on(document, i, `[data-bs-dismiss="${o}"]`, function (i) {
      if ((["A", "AREA"].includes(this.tagName) && i.preventDefault(), l(this)))
        return;
      const s = n(this) || this.closest(`.${o}`);
  ...
  z.on(document, "click.bs.button.data-api", U, (t) => {
    t.preventDefault();
  ...
  const V = {
    ...
    X = { leftCallback: null, rightCallback: null, endCallback: null },
    Y = {
  ...
  class Q extends B {
    ...
    _initEvents() {
      this._supportPointerEvents
        ? (z.on(this._element, "pointerdown.bs.swipe", (t) => this._start(t)),
          z.on(this._element, "pointerup.bs.swipe", (t) => this._end(t)),
          this._element.classList.add("pointer-event"))
        : (z.on(this._element, "touchstart.bs.swipe", (t) => this._start(t)),
          z.on(this._element, "touchmove.bs.swipe", (t) => this._move(t)),
          z.on(this._element, "touchend.bs.swipe", (t) => this._end(t)));
    }
  ...
  class rt extends H {
    ...
    _maybeEnableCycle() {
      this._config.ride &&
        (this._isSliding
          ? z.one(this._element, tt, () => this.cycle())
          : this.cycle());
    }
    to(t) {
      ...
      if (this._isSliding)
        return void z.one(this._element, tt, () => this.to(t));
    ...
    _addEventListeners() {
      this._config.keyboard &&
        z.on(this._element, "keydown.bs.carousel", (t) => this._keydown(t)),
        "hover" === this._config.pause &&
          (z.on(this._element, "mouseenter.bs.carousel", () => this.pause()),
          z.on(this._element, "mouseleave.bs.carousel", () =>
    ...
    _addTouchEventListeners() {
      ...
      this._swipeHelper = new Q(this._element, t);
    }
    _keydown(t) {
    ...
    _slide(t, e = null) {
      ...
      const i = this._getActive(),
        n = t === G,
        o = e || y(this._getItems(), i, n, this._config.wrap);
      if (o === i) return;
      const s = this._getItemIndex(o),
        r = (e) =>
          z.trigger(this._element, e, {
            relatedTarget: o,
    ...
    _directionToOrder(t) {
      return p() ? (t === J ? K : G) : t === J ? G : K;
    }
    _orderToDirection(t) {
      return p() ? (t === K ? J : Z) : t === K ? Z : J;
    }
    static jQueryInterface(t) {
      return this.each(function () {
  ...
  z.on(
    ...
    function (t) {
      ...
      return o
        ? (i.to(o), void i._maybeEnableCycle())
  ...
  class ft extends H {
    constructor(t, e) {
      ...
      for (const t of n) {
        const e = i(t),
          n = V.find(e).filter((t) => t === this._element);
  ...
  z.on(document, "click.bs.collapse.data-api", dt, function (t) {
    ("A" === t.target.tagName ||
  ...
  var pt = "top",
    ...
    xt = "popper",
    St = "reference",
    kt = bt.reduce(function (t, e) {
      return t.concat([e + "-" + _t, e + "-" + wt]);
    }, []),
    At = [].concat(bt, [yt]).reduce(function (t, e) {
      return t.concat([e, e + "-" + _t, e + "-" + wt]);
    }, []),
    Lt = "beforeRead",
    Tt = "read",
    Dt = "afterRead",
  ...
  function Yt(t, e) {
    ...
    if (Ht(t) && e) {
      var s = t.offsetHeight,
        r = t.offsetWidth;
      r > 0 && (n = Xt(i.width) / r || 1), s > 0 && (o = Xt(i.height) / s || 1);
    }
    return {
      width: i.width / n,
      height: i.height / o,
  ...
  function te(t) {
    return "html" === qt(t)
      ? t
      : t.assignedSlot || t.parentNode || (Wt(t) ? t.host : null) || Zt(t);
  }
  function ee(t) {
    return Ht(t) && "fixed" !== Kt(t).position ? t.offsetParent : null;
  }
  function ie(t) {
    for (var e = Ft(t), i = ee(t); i && Jt(i) && "static" === Kt(i).position; )
      i = ee(i);
    return i &&
      ("html" === qt(i) || ("body" === qt(i) && "static" === Kt(i).position))
      ? e
      : i ||
          (function (t) {
  ...
  const ae = {
    ...
    fn: function (t) {
      var e,
        ...
        a = Ut(i.placement),
        l = ne(a),
        c = [vt, mt].indexOf(a) >= 0 ? "height" : "width";
      if (s && r) {
        var d = (function (t, e) {
            return se(
              "number" !=
          ...
          E = oe(b, w, _),
          C = l;
        i.modifiersData[n] = (((e = {})[C] = E), (e.centerOffset = E - w), e);
      }
    },
    effect: function (t) {
      var e = t.state,
  ...
  function de(t) {
    ...
    var S,
      k = Object.assign({ position: a }, c && ce),
      A =
        !0 === d
          ? (function (t) {
              var e = t.x,
  ...
  function be(t) {
    return Yt(Zt(t)).left + ye(t).scrollLeft;
  }
  function _e(t) {
    var e = Kt(t),
      i = e.overflow,
  ...
  function Ee(t, e) {
    ...
    var n = we(t),
      ...
      s = Ft(n),
      r = o ? [s].concat(s.visualViewport || [], _e(n) ? n : []) : n,
      a = e.concat(r);
    return o ? a : a.concat(Ee(te(r)));
  }
  function Ce(t) {
      ...
      : Ce(
          (function (t) {
            var e,
              ...
              l = -n.scrollTop;
            return (
              "rtl" === Kt(o || i).direction &&
                (a += $t(i.clientWidth, o ? o.clientWidth : 0) - s),
  ...
  function ke(t, e) {
    ...
    var i = e,
      ...
      f = i.padding,
      p = void 0 === f ? 0 : f,
      g = se("number" != typeof p ? p : re(p, bt)),
      m = d === xt ? St : xt,
      v = t.rects.popper,
      y = t.elements[h ? m : d],
      b = (function (t, e, i) {
        var n =
            "clippingParents" === e
              ? (function (t) {
                  var e = Ee(te(t)),
                    i =
                      ["absolute", "fixed"].indexOf(Kt(t).position) >= 0 &&
                      Ht(t)
                        ? ie(t)
                        : t;
                  return Bt(i)
                    ? e.filter(function (t) {
                        return Bt(t) && Gt(t, i) && "body" !== qt(t);
                      })
                    : [];
                })(t)
              : [].concat(e),
          ...
          r = o.reduce(function (e, i) {
            ...
            return (
              (e.top = $t(n.top, e.top)),
              (e.right = Vt(n.right, e.right)),
              (e.bottom = Vt(n.bottom, e.bottom)),
              (e.left = $t(n.left, e.left)),
              e
            );
          }, xe(t, s));
        return (
      ...
      })(Bt(y) ? y : y.contextElement || Zt(t.elements.popper), r, l),
      _ = Yt(t.elements.reference),
      w = Se({ reference: _, element: v, strategy: "absolute", placement: o }),
      E = Ce(Object.assign({}, v, w)),
      C = d === xt ? E : _,
      x = {
          ...
          var o = i.mainAxis,
            ...
            y =
              ...
              (v !== m && p
                ...
                : [ge(m)]),
            b = [m].concat(y).reduce(function (t, i) {
              return t.concat(
                Ut(i) === yt
                  ? (function (t, e) {
                      void 0 === e && (e = {});
            ...
            return (
              (t[i] = (function (t, e, i) {
                ...
                return (
                  (r = r || 0),
                  (a = (a || 0) * o),
                  [vt, mt].indexOf(n) >= 0 ? { x: a, y: r } : { x: r, y: a }
                );
              })(i, e.rects, s)),
              t
            );
        ...
        if (E) {
          if (s) {
            var T,
              ...
              U = oe(0, C[I], B[I]),
              $ = b
                ? C[I] / 2 - M - U - W - k.mainAxis
                : j - U - W - k.mainAxis,
              V = b
                ? -C[I] / 2 + M + U + R + k.mainAxis
                : q + U + R + k.mainAxis,
              X = e.elements.arrow && ie(e.elements.arrow),
              Y = X ? ("y" === _ ? X.clientTop || 0 : X.clientLeft || 0) : 0,
              Q = null != (T = null == A ? void 0 : A[_]) ? T : 0,
              G = P + V - Q,
              K = oe(f ? Vt(z, P + $ - Q - Y) : z, P, f ? $t(N, G) : N);
            (E[_] = K), (L[_] = K - P);
          }
          if (a) {
            var J,
              ...
              nt = et + m[Z],
              ot = et - m[tt],
              st = -1 !== [pt, vt].indexOf(v),
              rt = null != (J = null == A ? void 0 : A[w]) ? J : 0,
              at = st ? nt : et - C[it] - x[it] - rt + k.altAxis,
              lt = st ? et + C[it] + x[it] - rt - k.altAxis : ot,
              ct =
                f && st
                  ? (function (t, e, i) {
                      var n = oe(t, e, i);
        ...
        (("body" !== qt(e) || _e(a)) &&
          (c =
            (n = e) !== Ft(n) && Ht(n)
              ...
              : ye(n)),
        Ht(e)
          ? (((d = Yt(e, !0)).x += e.clientLeft), (d.y += e.clientTop))
          : a && (d.x = be(a))),
      {
        ...
        d = {
          ...
          forceUpdate: function () {
            if (!c) {
              ...
              if (je(e, i)) {
                (a.rects = {
                  reference: ze(e, ie(i), "fixed" === a.options.strategy),
                  popper: Qt(i),
                }),
                  (a.reset = !1),
  ...
  var Fe = qe(),
    Be = qe({ defaultModifiers: [fe, Ie, ue, Rt] }),
    He = qe({ defaultModifiers: [fe, Ie, ue, Rt, Oe, Ae, Pe, ae, De] });
  ...
  class ri extends H {
    constructor(t, e) {
      super(t, e),
        ...
        (this._menu = V.findOne(Ke, this._parent)),
    ...
    _createPopper() {
      ...
      this._popper = He(t, this._menu, e);
    }
    _isShown() {
    ...
    _selectMenuItem({ key: t, target: e }) {
      ...
      i.length && y(i, e, t === $e, !i.includes(e)).focus();
    }
    static jQueryInterface(t) {
      return this.each(function () {
    ...
    static dataApiKeydownHandler(t) {
      const e = /input|textarea/i.test(t.target.tagName),
        i = "Escape" === t.key,
        n = [Ue, $e].includes(t.key);
      if (!n && !i) return;
      if (e && !i) return;
      t.preventDefault();
      const o = V.findOne(Qe, t.delegateTarget.parentNode),
        s = ri.getOrCreateInstance(o);
      if (n) return t.stopPropagation(), s.show(), void s._selectMenuItem(t);
      s._isShown() && (t.stopPropagation(), s.hide(), o.focus());
    }
  }
  z.on(document, Xe, Qe, ri.dataApiKeydownHandler),
    z.on(document, Xe, Ke, ri.dataApiKeydownHandler),
    z.on(document, Ve, ri.clearMenus),
    z.on(document, "keyup.bs.dropdown.data-api", ri.clearMenus),
    z.on(document, Ve, Qe, function (t) {
  ...
  class ui {
    ...
    hide() {
      ...
      this._disableOverFlow(),
        ...
        this._setElementAttributes(li, di, (e) => e - t);
    }
    reset() {
  ...
  const vi = ".bs.focustrap",
    yi = "backward",
    bi = { trapElement: null, autofocus: !0 },
    _i = { trapElement: "element", autofocus: "boolean" };
  class wi extends B {
    constructor(t) {
      super(),
        (this._config = this._getConfig(t)),
    ...
    activate() {
      this._isActive ||
        ...
        z.off(document, vi),
        z.on(document, "focusin.bs.focustrap", (t) => this._handleFocusin(t)),
        z.on(document, "keydown.tab.bs.focustrap", (t) =>
          this._handleKeydown(t)
        ),
        (this._isActive = !0));
    }
    deactivate() {
      this._isActive && ((this._isActive = !1), z.off(document, vi));
    }
    _handleFocusin(t) {
  ...
  class Ti extends H {
    ...
    show(t) {
      this._isShown ||
        ...
        z.trigger(this._element, Ci, { relatedTarget: t }).defaultPrevented ||
        ((this._isShown = !0),
        (this._isTransitioning = !0),
        ...
        this._queueCallback(
          () => {
            this._config.focus && this._focustrap.activate(),
              (this._isTransitioning = !1),
              z.trigger(this._element, "shown.bs.modal", { relatedTarget: t });
          },
          this._dialog,
          this._isAnimated()
        );
    ...
    static jQueryInterface(t, e) {
      return this.each(function () {
        const i = Ti.getOrCreateInstance(this, t);
        if ("string" == typeof t) {
          if (void 0 === i[t]) throw new TypeError(`No method named "${t}"`);
          i[t](e);
        }
  ...
  z.on(
    ...
    function (t) {
      ...
      i && Ti.getInstance(i).hide(), Ti.getOrCreateInstance(e).toggle(this);
    }
  ),
    W(Ti),
    g(Ti);
  const Di = "show",
    ...
    Mi = { backdrop: !0, keyboard: !0, scroll: !1 },
    ji = {
      backdrop: "(boolean|string)",
      keyboard: "boolean",
      scroll: "boolean",
  ...
  class qi extends H {
    ...
    show(t) {
      this._isShown ||
        z.trigger(this._element, "show.bs.offcanvas", { relatedTarget: t })
          .defaultPrevented ||
        ((this._isShown = !0),
        this._backdrop.show(),
    ...
    hide() {
      this._isShown &&
        (z.trigger(this._element, "hide.bs.offcanvas").defaultPrevented ||
          (this._focustrap.deactivate(),
          this._element.blur(),
          (this._isShown = !1),
    ...
    _addEventListeners() {
      z.on(this._element, "keydown.dismiss.bs.offcanvas", (t) => {
        "Escape" === t.key &&
          (this._config.keyboard ? this.hide() : z.trigger(this._element, zi));
      });
    }
    static jQueryInterface(t) {
      return this.each(function () {
  ...
  const Fi = new Set([
    ...
    Wi = (t, e) => {
      ...
      return e.includes(i)
        ? !Fi.has(i) || Boolean(Bi.test(t.nodeValue) || Hi.test(t.nodeValue))
  ...
  class Xi extends B {
    ...
    _checkContent(t) {
      for (const [e, i] of Object.entries(t))
        super._typeCheckConfig({ selector: e, entry: i }, Vi);
    }
    _setContent(t, e, i) {
        ...
        ? (function (t, e, i) {
            ...
            for (const t of o) {
              ...
              const n = [].concat(...t.attributes),
                o = [].concat(e["*"] || [], e[i] || []);
              for (const e of n) Wi(e, o) || t.removeAttribute(e.nodeName);
            }
  ...
  class sn extends H {
    ...
    dispose() {
      clearTimeout(this._timeout),
        z.off(this._element.closest(Ki), Ji, this._hideModalHandler),
    ...
    show() {
      ...
      if (
        (this._element.ownerDocument.documentElement.contains(this.tip) ||
          (n.append(i),
          z.trigger(this._element, this.constructor.eventName("inserted"))),
        ...
        this._queueCallback(
          () => {
            this._isWithActiveTrigger() ||
              ...
              z.trigger(this._element, this.constructor.eventName("hidden")),
              this._disposePopper());
          },
          this.tip,
          this._isAnimated()
    ...
    _createTipElement(t) {
      ...
      return (
        e.setAttribute("id", i), this._isAnimated() && e.classList.add(Qi), e
      );
    }
    setContent(t) {
      let e = !1;
    ...
    _isAnimated() {
      return (
        this._config.animation || (this.tip && this.tip.classList.contains(Qi))
      );
    }
    _isShown() {
    ...
    _createPopper(t) {
      const e =
        ...
        i = en[e.toUpperCase()];
      this._popper = He(this._element, t, this._getPopperConfig(i));
    }
    _getOffset() {
      const { offset: t } = this._config;
      return "string" == typeof t
    ...
    _setListeners() {
      ...
      (this._hideModalHandler = () => {
        ...
        z.on(this._element.closest(Ki), Ji, this._hideModalHandler),
        this._config.selector
          ? (this._config = {
              ...this._config,
              trigger: "manual",
  ...
  const rn = {
    ...
    an = { ...sn.DefaultType, content: "(null|string|element|function)" };
  class ln extends sn {
    static get Default() {
      return rn;
    }
  ...
  class pn extends H {
    ...
    _maybeEnableSmoothScroll() {
      this._config.smoothScroll &&
        (z.off(this._config.target, cn),
        z.on(this._config.target, cn, un, (t) => {
    ...
    _initializeTargetsAndObservables() {
      ...
      const t = V.find(un, this._config.target);
      for (const e of t) {
    ...
    _process(t) {
      this._activeTarget !== t &&
        ...
        z.trigger(this._element, "activate.bs.scrollspy", {
          relatedTarget: t,
        }));
    }
    _activateParents(t) {
      if (t.classList.contains("dropdown-item"))
        V.findOne(".dropdown-toggle", t.closest(".dropdown")).classList.add(dn);
      else
  ...
  z.on(window, "load.bs.scrollspy.data-api", () => {
    for (const t of V.find('[data-bs-spy="scroll"]')) pn.getOrCreateInstance(t);
  }),
    g(pn);
  const gn = "ArrowLeft",
    mn = "ArrowRight",
    ...
    Cn = `.nav-link:not(.dropdown-toggle), .list-group-item:not(.dropdown-toggle), [role="tab"]:not(.dropdown-toggle), ${En}`;
  class xn extends H {
    constructor(t) {
      super(t),
        ...
        this._parent &&
          ...
          z.on(this._element, "keydown.bs.tab", (t) => this._keydown(t)));
    }
    static get NAME() {
      return "tab";
    }
    show() {
      ...
      const e = this._getActiveElem(),
        i = e ? z.trigger(e, "hide.bs.tab", { relatedTarget: t }) : null;
      z.trigger(t, "show.bs.tab", { relatedTarget: e }).defaultPrevented ||
        (i && i.defaultPrevented) ||
        (this._deactivate(e, t), this._activate(t, e));
    }
    _activate(t, e) {
      if (!t) return;
      t.classList.add(bn), this._activate(n(t));
      const i = t.classList.contains(_n);
      this._queueCallback(
        () => {
          i && t.classList.add(wn),
            "tab" === t.getAttribute("role") &&
              ...
              z.trigger(t, "shown.bs.tab", { relatedTarget: e }));
        },
        t,
        i
      );
    ...
    _deactivate(t, e) {
      if (!t) return;
      t.classList.remove(bn), t.blur(), this._deactivate(n(t));
      const i = t.classList.contains(_n);
      this._queueCallback(
        () => {
          i && t.classList.remove(wn),
            "tab" === t.getAttribute("role") &&
              ...
              z.trigger(t, "hidden.bs.tab", { relatedTarget: e }));
        },
        t,
        i
      );
    ...
    _keydown(t) {
      if (![gn, mn, vn, yn].includes(t.key)) return;
      t.stopPropagation(), t.preventDefault();
      const e = [mn, yn].includes(t.key),
        i = y(
      ...
      i && xn.getOrCreateInstance(i).show();
    }
    _getChildren() {
      return V.find(Cn, this._parent);
    }
    _getActiveElem() {
    ...
    _toggleDropDown(t, e) {
      ...
      const n = (t, n) => {
        const o = V.findOne(t, i);
        o && o.classList.toggle(n, e);
      };
      n(".dropdown-toggle", bn),
        n(".dropdown-menu", wn),
        n(".dropdown-item", bn),
        i.setAttribute("aria-expanded", e);
    }
    ...
    _getInnerElement(t) {
      return t.matches(Cn) ? t : V.findOne(Cn, t);
    }
    _getOuterElement(t) {
  ...
  z.on(document, "click.bs.tab", En, function (t) {
    ["A", "AREA"].includes(this.tagName) && t.preventDefault(),
  ...
  class Dn extends H {
    ...
    show() {
      z.trigger(this._element, "show.bs.toast").defaultPrevented ||
        ...
        u(this._element),
        this._element.classList.add(kn, An),
        this._queueCallback(
          () => {
          ...
          this._queueCallback(
            () => {
              this._element.classList.add(Sn),
                this._element.classList.remove(An, kn),
    ...
    _setListeners() {
      z.on(this._element, "mouseover.bs.toast", (t) =>
        this._onInteraction(t, !0)
      ),
        z.on(this._element, "mouseout.bs.toast", (t) =>
          this._onInteraction(t, !1)
        ),
        z.on(this._element, "focusin.bs.toast", (t) =>
          this._onInteraction(t, !0)
        ),
        z.on(this._element, "focusout.bs.toast", (t) =>
          this._onInteraction(t, !1)
        );
    }
    _clearTimeout() {
  ...
  (function (t, e) {
    ...
    var e,
      ...
      r = function (e, i) {
        var a = this;
        if (
          ((i = i || {}), !(e = "string" == typeof e ? n.querySelector(e) : e))
        )
          return !1;
        i.queries && s("queries", "responsive", "option"),
          i.queryFlow && s("queryFlow", "mobileFirst", "option");
        var l = {},
          c = r.Helpers,
          d = e.parentNode;
        function u(t) {
        ...
        function f() {
          ...
          if (n) {
            var s = t.innerWidth;
            if (((e = i), (l = Object.assign({}, o, e || {})).mobileFirst))
              for (var r in n) r <= s && !c.isEmptyObject(n[r]) && u(n[r]);
            else {
              var a,
                d = [];
              for (a in n) {
              ...
              for (var f = d.length - 1; 0 <= f; f--) {
                var p = d[f],
                  g = Object.keys(p)[0];
                s <= g && !c.isEmptyObject(p[g]) && u(p[g]);
              }
            }
          }
        }
        function p() {
          (z = j()), (C = M()), (I = x + C - A - D), (P = k < z);
          var i,
          ...
          (F = o < W ? "up" : "down"),
            (q = o - W),
            O < (W = o)
              ? I + A + (P ? L : 0) - (l.followScroll && P ? 0 : A) <=
                o +
                  z -
                  T -
                  (k - (O - T) < z - T && l.followScroll && 0 < (i = z - k - T)
                    ? i
                    : 0)
                ? B.release({
                    position: "absolute",
                    bottom: S + d.offsetHeight - I - A,
                  })
                : P && l.followScroll
                ? "down" == F
                  ? r + z + L <= k + 0.9
                  ...
                  : Math.ceil(r + T) < 0 && "fixed" === B.position
                  ? B.release({ position: "absolute", top: s - A - O + T - q })
                  : o + A - T <= s && B.stick({ top: A - T })
                : B.stick({ top: A - T })
              : B.release({ stop: !0 });
        }
        function g() {
          R &&
            (t.removeEventListener("scroll", p, c.supportsPassive), (R = !1));
        }
        function m() {
          null !== e.offsetParent && "none" !== c.getStyle(e, "display")
            ? ((function () {
                ...
                (B.css =
                  ...
                  (w = l.stickTo ? (_ ? n : c.getElement(l.stickTo)) : d),
                  (z = (j = function () {
                    var t =
                        e.offsetHeight +
                        (parseInt(B.css.marginTop) || 0) +
                        (parseInt(B.css.marginBottom) || 0),
                      i = (z || 0) - t;
                    return -1 <= i && i <= 1 ? z : t;
                  })()),
                  (C = (M = function () {
                  ...
                  (x = _ ? 0 : c.offset(w).top),
                  (S = l.stickTo ? (_ ? 0 : c.offset(d).top) : x),
                  (k = t.innerHeight),
                  (N = e.offsetTop - (parseInt(B.css.marginTop) || 0)),
              ...
              C < z
                ...
                : (p(),
                  R ||
                    (t.addEventListener("scroll", p, c.supportsPassive),
                    (R = !0))))
            : g();
        }
        function v() {
          (e.style.position = ""),
            ...
            e.classList
              ...
              : (e.className = e.className.replace(
                  new RegExp(
                    "(^|\\b)" + l.stickyClass.split(" ").join("|") + "(\\b|$)",
                    "gi"
                  ),
                  " "
                )),
            (B.css = {}),
            !(B.position = null) === H.isAttached && H.detach();
        }
        function y() {
          v(), f(), (h() ? g : m)();
        }
        function b() {
          U &&
            (t.removeEventListener("resize", V, c.supportsPassive), (U = !1)),
            g();
        }
        ...
        var _,
                  ...
                  ((void 0 === t.top && void 0 === t.bottom) ||
                    ...
                    (void 0 !== t.bottom &&
                      (parseInt(c.getStyle(e, "bottom")) || 0) ===
                        t.bottom))) ||
                  (!0 === t.stop
                    ? !0 === H.isAttached && H.detach()
                    : !1 === H.isAttached && H.attach(),
                  (i = t.position || B.css.position),
                  (B.position = i),
                  (e.style.position = i),
                  (e.style.left =
                    !0 === t.stop ? B.css.left : H.positionLeft + "px"),
                  (e.style.width = ("absolute" !== i ? B.css : H).width),
                  void 0 === t.bottom
          ...
          H = {
            ...
            isAttached: !1,
            init: function () {
              for (var t in ((H.el.className = "sticky-spacer"), B.css))
                H.el.style[t] = B.css[t];
              H.el.style["z-index"] = "-1";
              var i = c.getStyle(e);
              (H.offsetLeft = c.offset(e).left - (parseInt(i.marginLeft) || 0)),
                (H.positionLeft = c.position(e).left),
                (H.width = c.getStyle(e, "width"));
            },
            attach: function () {
              d.insertBefore(H.el, e), (H.isAttached = !0);
            },
            detach: function () {
              (H.el = d.removeChild(H.el)), (H.isAttached = !1);
            },
          },
          W = t.pageYOffset || n.documentElement.scrollTop,
          R = !1,
          U = !1,
          $ = function () {
            l.onBeforeResize && l.onBeforeResize.call(e, Object.assign({}, l)),
              y(),
              l.onResize && l.onResize.call(e, Object.assign({}, l));
          },
          V = l.resizeDebounce ? c.debounce($, l.resizeDebounce) : $;
        $ = function () {
          U || (t.addEventListener("resize", V, c.supportsPassive), (U = !0)),
            f(),
            (h() ? g : m)();
        };
      ...
      void 0 !== t.jQuery &&
        ...
        e.fn.extend({
          hcSticky: function (t, n) {
            return this.length
              ? "options" === t
                ? e.data(this.get(0), i).options()
                : this.each(function () {
                    var o = e.data(this, i);
                    o
                      ? o.triggerMethod(t, n)
                      : ((o = new r(this, t)), e.data(this, i, o));
                  })
              : this;
          },
        })),
      (t.hcSticky = t.hcSticky || r),
      r
    );
  }),
  (function (t) {
    ...
    "function" != typeof Object.assign &&
      ...
      Array.prototype.forEach ||
        (Array.prototype.forEach = function (t) {
          ...
          for (1 < arguments.length && (e = arguments[1]), i = 0; i < s; )
            i in o && ((n = o[i]), t.call(e, n, i, o)), i++;
        });
    var n = !1;
    try {
    ...
    function s(e, n) {
      return t.getComputedStyle
        ? n
          ? i.defaultView.getComputedStyle(e, null).getPropertyValue(n)
          : i.defaultView.getComputedStyle(e, null)
        : e.currentStyle
        ? n
          ? e.currentStyle[
              n.replace(/-\w/g, function (t) {
    ...
    function r(e) {
      ...
      e = t.pageXOffset || i.documentElement.scrollLeft;
      return { top: n.top + o, left: n.left + e };
    }
    e.Helpers = {
      supportsPassive: n,
      ...
      offset: r,
      position: function (t) {
        var e = r((n = t.offsetParent)),
          i = r(t),
          n = s(n);
        t = s(t);
        return (
          (e.top += parseInt(n.borderTopWidth) || 0),
          (e.left += parseInt(n.borderLeftWidth) || 0),
          {
            top: i.top - e.top - (parseInt(t.marginTop) || 0),
            left: i.left - e.left - (parseInt(t.marginLeft) || 0),
          }
        );
      },
      ...
      getCascadedStyle: function (e) {
        ...
        return (
          ...
          l.margin ||
            ...
            "0px" !== l.marginRight ||
            ((a =
              (r = e.offsetLeft - e.parentNode.offsetLeft) -
              (parseInt(l.left) || 0) -
              (parseInt(l.right) || 0)),
            (0 !=
              (a =
        ...
        i.docReady(function () {
          ...
          c.forEach(function (t) {
            ...
            try {
              ...
              return void (
                o &&
                o.error("Error parsing " + r + " on " + t.className + ": " + s)
              );
            }
            var a = new e(t, i);
            u && u.data(t, n, a);
  ...
  (function (t, e) {
    ...
    var e = "undefined" != typeof window,
      ...
      N = function (t, e) {
        var i = t.parentNode;
        i && "PICTURE" === i.tagName && z(i).forEach(e);
      },
      M = function (t, e) {
        z(t).forEach(e);
      },
      ...
      V = function (t, e, i) {
        L(t, e.class_applied),
          E(t, v),
          i && (e.unobserve_completed && O(t, e), A(e.callback_applied, t, i));
      },
      X = function (t, e, i) {
        L(t, e.class_loading),
          E(t, g),
          i && (I(i, 1), A(e.callback_loading, t, i));
      },
      Y = function (t, e, i) {
        i && t.setAttribute(e, i);
      },
      Q = function (t, e) {
        Y(t, u, _(t, e.data_sizes)),
          Y(t, d, _(t, e.data_srcset)),
          Y(t, c, _(t, e.data_src));
      },
      G = {
        IMG: function (t, e) {
          N(t, function (t) {
        ...
        VIDEO: function (t, e) {
          M(t, function (t) {
            ...
            U(t, q),
            Y(t, h, _(t, e.data_poster)),
            Y(t, c, _(t, e.data_src)),
            t.load();
        },
        OBJECT: function (t, e) {
          U(t, B), Y(t, p, _(t, e.data_src));
        },
      },
        ...
        !(function (t) {
          ...
          ? (function (t, e, i) {
              !(function (t) {
                ...
                ot(t, e, i),
                (function (t) {
                  H(t) || (t[f] = { backgroundImage: t.style.backgroundImage });
                })(t),
                (function (t, e, i) {
                  var n = _(t, e.data_bg),
                  ...
                  r &&
                    ...
                    D(t).setAttribute(c, r),
                    X(t, e, i));
                })(t, e, i),
                (function (t, e, i) {
                  var n = _(t, e.data_bg_multi),
                    o = _(t, e.data_bg_multi_hidpi),
                    r = s && o ? o : n;
                  r && ((t.style.backgroundImage = r), V(t, e, i));
                })(t, e, i),
                (function (t, e, i) {
                  var n = _(t, e.data_bg_set);
                  if (n) {
                    var o = n.split("|"),
                      s = o.map(function (t) {
          ...
          (function (t, i) {
            e &&
              ((i._onlineHandler = function () {
                !(function (t, e) {
                  var i;
                  ((i = ht(t)), ut(i).filter(ft)).forEach(function (e) {
                    T(e, t.class_error), C(e);
                  }),
                    e.update();
                })(t, i);
              }),
  ...
  (function () {
    ...
    function E() {
      if (!l && document.body) {
        ...
        var n = document.body,
          ...
          d = n.scrollHeight;
        if (
          ((c = document.compatMode.indexOf("CSS") >= 0 ? o : n),
          (t = n),
          s.keyboardSupport && R("keydown", L),
          top != self)
        )
          r = !0;
        else if (rt && d > a && (n.offsetHeight <= a || o.offsetHeight <= a)) {
          var u,
            ...
            (i = function () {
              u ||
                (u = setTimeout(function () {
                  (h.style.height = "0"),
                    (h.style.height = c.scrollHeight + "px"),
                    (u = null);
                }, 500));
            }),
            setTimeout(i, 10),
    ...
    function k(t, e, i) {
      ...
      if (
        ((n = (n = e) > 0 ? 1 : -1),
        (o = (o = i) > 0 ? 1 : -1),
        (a.x !== n || a.y !== o) && ((a.x = n), (a.y = o), (C = []), (S = 0)),
        1 != s.accelerationMax)
      ) {
        var r = Date.now() - S;
        if (r < s.accelerationDelta) {
          var l = (1 + 50 / r) / 2;
          l > 1 && ((l = Math.min(l, s.accelerationMax)), (e *= l), (i *= l));
        }
        S = Date.now();
      }
      if (
        ...
        var u = function (n) {
          for (var o = Date.now(), r = 0, a = 0, l = 0; l < C.length; l++) {
            var c = C[l],
              h = o - c.start,
              f = h >= s.animationTime,
              p = f ? 1 : h / s.animationTime;
            s.pulseAlgorithm && (p = Z(p));
            var g = (c.x * p - c.lastX) >> 0,
              m = (c.y * p - c.lastY) >> 0;
            (r += g),
              (a += m),
              (c.lastX += g),
          ...
          d
            ? window.scrollBy(r, a)
            : (r && (t.scrollLeft += r), a && (t.scrollTop += a)),
            e || i || (C = []),
            C.length
              ? Q(u, t, 1e3 / s.frameRate + 1)
              : ((x = !1),
                null != t.$scrollBehavior &&
    ...
    function A(e) {
      ...
      u &&
        ...
        o || a || (a = -e.wheelDelta || 0),
        1 === e.deltaMode && ((o *= 40), (a *= 40));
      var c = F(i);
      return c
        ? !!(function (t) {
            if (!t) return;
            ...
            (Math.abs(o) > 1.2 && (o *= s.stepSize / 120),
    ...
    function L(e) {
      var i = e.target,
        n =
          e.ctrlKey || e.altKey || e.metaKey || (e.shiftKey && e.keyCode !== m);
      ...
      if (
        ...
        return !0;
      if (
        ($(i, "button") || ($(i, "input") && o.test(i.type))) &&
        e.keyCode === m
      )
        return !0;
      ...
      var a = 0,
        l = 0,
        c = F(t);
      if (!c) return !r || !it || parent.keydown(e);
    ...
    function j(t, e, i) {
      for (var n = i ? P : z, o = t.length; o--; ) n[I(t[o])] = e;
      return e;
    }
    function q(t, e) {
      return (e ? P : z)[I(t)];
    ...
    function F(t) {
      ...
      do {
        ...
        if ((e.push(t), n === t.scrollHeight)) {
          var s = (H(c) && H(i)) || W(c);
          if ((r && B(c)) || (!r && s)) return j(e, K());
        } else if (B(t) && W(t)) return j(e, t);
    ...
    function X(t) {
      return V(d[0], t) && V(d[1], t) && V(d[2], t);
    }
    var Y,
      Q =
    ...
    function Z(t) {
      return t >= 1
        ...
        : t <= 0
        ? 0
        : (1 == s.pulseNormalize && (s.pulseNormalize /= J(1)), J(t));
    }
    var tt = window.navigator.userAgent,
      et = /Edge/.test(tt),
      it = /chrome/i.test(tt) && !et,
      nt = /safari/i.test(tt) && !et,
      ot = /mobile/i.test(tt),
      st = /Windows NT 6.1/i.test(tt) && /rv:11/i.test(tt),
      rt = nt && (/Version\/8/i.test(tt) || /Version\/9/i.test(tt)),
      at = (it || nt || st) && !ot,
      lt = !1;
    try {
    ...
    var ct = !!lt && { passive: !1 },
      dt = "onwheel" in document.createElement("div") ? "wheel" : "mousewheel";
    function ut(t) {
      for (var e in t) o.hasOwnProperty(e) && (s[e] = t[e]);
    }
    dt && at && (R(dt, A, ct), R("mousedown", T), R("load", E)),
      (ut.destroy = function () {
        e && e.disconnect(),
          U(dt, A),
          U("mousedown", T),
      ...
      window.SmoothScrollOptions && ut(window.SmoothScrollOptions),
      "function" == typeof define && define.amd
        ? define(function () {
            return ut;
          })
    ...
    !(function () {
      var t = document.querySelector(".back-top"),
        ...
        n = function (t) {
          r(t) && (t = { to: t });
          var e = a(i, t);
          (e.startingYOffset = window.pageYOffset),
            (e.distanceYOffset = parseInt(e.to, 10) - e.startingYOffset),
        ...
        o = function t(e, i) {
          ...
          var n = i - e.startTime,
            o = Math.round(
              e.easing(n, e.startingYOffset, e.distanceYOffset, e.duration)
            );
          n < e.duration
        ...
        a = function (t, e) {
          var i = {};
          for (var n in t) i[n] = e[n] || t[n];
          return i;
        },
        l = function (t, e, i, n) {
          return i * (t /= n) * t * t * t * t + e;
        };
      const c = document.querySelectorAll(".back-top");
      if (null != c)
        for (var d = 0; d < c.length; d++)
          c[d].addEventListener("click", function () {
            n({ easing: l, duration: 800 });
          });
      window.addEventListener("scroll", function () {
        (e = window.scrollY) > 300
          ? t.classList.add("backtop-is-visible")
          : t.classList.remove("backtop-is-visible", "backtop-fade-out"),
          e > 1200 && t.classList.add("backtop-fade-out");
      });
    })(),
      null != document.querySelector(".dropdown > .dropdown-menu > li") &&
        ((function () {
          for (
            var t = document.querySelectorAll(
              ...
              e = function (e) {
                t[e].addEventListener("click", function (i) {
                  i.stopPropagation(),
                    i.preventDefault(),
                    t[e].nextElementSibling.classList.toggle("show"),
                    t[e].parentNode.classList.toggle("show");
                }),
                  window.addEventListener("mouseup", function (i) {
                    i.target != t[e].nextElementSibling &&
                      i.target.parentNode != t[e].nextElementSibling &&
                      1 != i.target.classList.contains("dropdown-toggle") &&
                      (t[e].nextElementSibling.classList.remove("show"),
                      t[e].parentNode.classList.remove("show"));
                  });
              },
              i = 0;
            i < t.length;
        ...
        (function () {
          for (
            var t = document.querySelectorAll(".navbar-nav > .dropdown"),
              e = document.querySelectorAll(".dropdown-menu li .dropdown-menu"),
              i = function (i) {
                t[i].addEventListener("hide.bs.dropdown", function () {
                  for (var t = 0; t < e.length; t++)
                    i != t &&
                      (e[t].classList.remove("show"),
                      e[t].parentNode.classList.remove("show"));
                });
              },
              n = 0;
            n < t.length;
                ...
                t[n].addEventListener("click", function () {
                  for (var t = 0; t < e.length; t++)
                    n != t &&
                      ...
                      e[t].classList.remove("show"),
                      void 0 === i[t] ||
                        (i[t].parentNode.classList.remove("show"),
                        i[t].classList.remove("show")));
                });
              },
              o = 0;
            o < t.length;
              ...
              i = function (i) {
                t[i].addEventListener("click", function () {
                  ...
                  t[i].addEventListener("mouseenter", function () {
                    for (var t = 0; t < e.length; t++) {
                      var i = e[t];
                      i.getBoundingClientRect().left + i.offsetWidth >
                        (window.innerWidth ||
                          document.documentElement.clientWidth ||
                          document.body.clientWidth) &&
                        i.classList.add("dropdown-reverse");
                    }
                  });
              },
              n = 0;
      ...
      (function () {
        var t = document.querySelectorAll(".back-menu");
        if (null != t)
          for (var e = 0; e < t.length; e++)
            t[e].addEventListener("click", function () {
              for (
                var t = document.getElementsByClassName("push"), e = 0;
                e < t.length;
                e++
              )
                t[e].classList.remove("push-open");
              var i = document.querySelectorAll(".mobile-side");
              for (e = 0; e < i.length; e++)
                i[e].classList.remove("sidenav-body-open");
            });
      })(),
      (function () {
        var t = document.querySelectorAll(".sidebar-menu-trigger");
        if (null != t)
          for (var e = 0; e < t.length; e++)
            t[e].addEventListener("click", function () {
              for (
                ...
                t[e].classList.add("push-open");
              var i = document.querySelectorAll(".mobile-side");
              for (e = 0; e < i.length; e++)
                i[e].classList.add("sidenav-body-open");
            });
      })(),
      (t = 0),
      window.addEventListener(
      ...
      (function () {
        ...
        window.addEventListener(
          "scroll",
          function () {
            var e = document.querySelector(".suggestion-box"),
              i = document.body.scrollTop || document.documentElement.scrollTop;
            if (null != e) {
              var n = document.querySelector(".post-content").offsetHeight;
              i >= t
                ? i >= n && e.classList.add("show")
                : i <= n && e.classList.remove("show");
            }
            t = i <= 0 ? 0 : i;
          },
          !1
      ...
      (function () {
        var t = document.querySelectorAll(".close-suggestion");
        if (null != t)
          for (var e = 0; e < t.length; e++)
            t[e].addEventListener("click", function () {
              for (
                var t = document.getElementsByClassName("suggestion-box"),
                  e = 0;
                e < t.length;
                e++
              )
                t[e].classList.add("close");
            });
      })(),
      (function () {
        if (null != document.querySelector(".lazy"))
          new LazyLoad({
            ...
            callback_reveal: function (t) {
              t.complete &&
                0 !== t.naturalWidth &&
                (t.classList.remove("loading"), t.classList.add("loaded"));
            },
          });
      })(),
      (function () {
      ...
      (function () {
        if (window.matchMedia("(max-width: 991px)").matches) {
          ...
          window.addEventListener(
            "scroll",
            function () {
              var e = document.querySelector(".mobile-sticky"),
                i = document.querySelector(".top-menu"),
                n =
                  document.body.scrollTop || document.documentElement.scrollTop;
              if (null != e) {
                var o =
                  document.querySelector(".mobile-sticky").offsetHeight + "px";
                if (null != i)
                  var s = document.querySelector(".top-menu").offsetHeight;
                else s = document.querySelector(".header").offsetHeight;
                n >= t
                  ? n >= s &&
      ...
      (function () {
        ...
        const n = [].slice.call(document.querySelectorAll(".toast"));
        null != n &&
          n.map(function (t) {
            return new bootstrap.Toast(t, option);
          });
      })();
  })();
