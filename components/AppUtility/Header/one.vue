      ...
      <div class="container">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark px-0 py-0">
          ...
          <div id="navbarTogglerDemo" class="collapse navbar-collapse">
            ...
            <ul class="navbar-nav">
              <li class="nav-item">
                <a class="nav-link" href="#">U.S News </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#">Europe News </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#">Africa News </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#">Gulf News </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#">Asia News </a>
              </li>
            </ul>
            <!--end top left menu-->
            <!--Top right menu-->
          ...
          <div class="sidenav-menu">
            <nav class="navbar navbar-light navbar-inverse">
              ...
              >
                ...
                <!-- dropdown menu start -->
                <li
                  class="menu-item menu-item-has-children dropdown mega-dropdown nav-item"
                >
                  <a
                    href="#"
                  ...
                  >
                    <li class="menu-item nav-item">
                      <a href="../category/category.html" class="dropdown-item"
                        >Cars</a
                      >
                    </li>
                  </ul>
                ...
                >
                  ...
                  >
                    ...
                    <li
                      class="menu-item menu-item-has-children mega-dropdown nav-item"
                    >
                      <a
                        href="#"
