      ...
      <div class="mobile-sticky fs-6 bg-black">
        <div class="container">
          ...
          <nav class="navbar navbar-expand-lg navbar-dark px-0 py-0">
            ...
            <!-- Mobile logo -->
            <a href="/">
              <img class="mobile-logo img-fluid d-lg-none mx-auto" src="https://demo.bootstrap.news/bootnews/assets/img/logo/logo-mobile.png" alt="Logo site">
            </a>
            <!--Right Toggle Button-->
            ...
            <div class="col-lg-4">
              <div id="main-logo" class="main-logo my-2 my-lg-4 d-none d-lg-block">
                <a class="navbar-brand" href="/">
                  <img class="img-fluid" src="https://demo.bootstrap.news/bootnews/assets/img/logo/default-logo.png" alt="Logo site">
                </a>
              </div>
            </div>
            <!--Right content ads-->
            <div class="col-lg-8">
              <div class="my-2 my-md-3 my-lg-4 d-none d-md-block text-center">
                <a href="/" target="_blank">
                  <img class="img-fluid bg-light" src="https://demo.bootstrap.news/bootnews/assets/img/ads/728-demo.png" alt="Advertiser space">
                </a>
              </div>
            </div>
          </div>
