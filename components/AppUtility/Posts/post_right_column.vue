              ...
              <div class="col-9 col-md-8">
                <div class="card-body pt-0">
                  <h3 class="card-title h6 h5-sm h6-md">
                    <a href="#"
                      >Apple's stock rout starts and ends with the iPhone</a
                    >
                  </h3>
              ...
              <div class="col-9 col-md-8">
                <div class="card-body pt-0">
                  <h3 class="card-title h6 h4-sm h6-md">
                    <a href="#"
                      >Ford reveals autonomous philosophies, priorities</a
                    >
                  </h3>
                  <div class="card-text small text-muted">
            ...
            <div class="row">
              ...
              <div class="col-9 col-md-8">
                <div class="card-body pt-0">
                  <h3 class="card-title h6 h4-sm h6-md">
                    <a href="#"
                      >Bowen's Super Bowl LIII game plans: Which defense will
                      get stops?</a
                    >
                  </h3>
                  <div class="card-text small text-muted">
        ...
        <div class="small-post">
          ...
          <article class="card card-full hover-a mb-2">
            <div class="card-body pt-0">
              ...
              <h3 class="card-title h5">
                <a href="#"
                  >Fans celebrate in Paris after side reaches World Cup final</a
                >
              </h3>
              <!--date-->
              <div class="card-text small text-muted">
          ...
          <article class="card card-full hover-a mb-2">
            <div class="card-body pt-0">
              ...
              <h3 class="card-title h5">
                <a href="#"
                  >The 52 Places Traveler: Summer in , in Two Very Different
                  Ways</a
                >
              </h3>
              <!--date-->
          ...
          <article class="card card-full hover-a mb-2">
            <div class="card-body pt-0">
              ...
              <h3 class="card-title h5">
                <a href="#"
                  >6 Simple Tips to Help or Vegan Travelers Eat Well,
                  Anywhere</a
                >
              </h3>
              <!--date-->
